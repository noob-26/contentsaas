...
const App = () => {
  return (
    <div>
      {/* Mirrored from htmlstream.com/space/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Oct 2021 07:04:25 GMT */}
      ...
      <main id="content" role="main">
        ...
        <div className="bg-primary-dark position-relative overflow-hidden">
          <div className="container content-space-2">
              ...
              <div className="col-md-8 col-lg-6 mb-7 mb-lg-0">
                ...
                <div className="pe-lg-3 mb-7">
                  ...
                  <p className="lead text-white-70">
                    Built on standard web technology, teams use Space to build
                      ...
                      <div className="row align-items-sm-center mb-5">
                        ...
                        <div className="col-sm">
                          ...
                          <p className="card-text">
                            Hundreds of companies using Space to build their
                            business.
                          </p>
                        </div>
                        {/* End Col */}
                      ...
                      <form>
                        ...
                        <div className="d-grid text-center">
                          ...
                          <span className="form-text">
                            Need help?{" "}
                            <a className="link" href="page-help-center.html">
            ...
            {/* End Row */}
            <div className="border-top border-white-10 my-10" />
            <div className="row">
              <div className="col-sm mb-5 mb-sm-0">
                ...
                <img
                  ...
                  src="assets/svg/brands/amazon-white-50.svg"
                  alt="Logo"
                />
              </div>
              {/* End Col */}
              <div className="col-sm mb-5 mb-sm-0">
                ...
                {/* End Rating */}
                <blockquote className="blockquote blockquote-sm text-white mb-4">
                  “ The best template I've ever come across. ”
                </blockquote>
                <img
                  className="avatar avatar-lg avatar-4x3"
                  src="assets/svg/brands/airbnb-white-50.svg"
                  alt="Logo"
                />
              </div>
              {/* End Col */}
              <div className="col-sm mb-5">
                ...
                {/* End Rating */}
                <blockquote className="blockquote blockquote-sm text-white mb-4">
                  “ There one theme is everything that user wants. ”
                </blockquote>
                <img
                  className="avatar avatar-lg avatar-4x3"
                  src="assets/svg/brands/google-white-50.svg"
                  alt="Logo"
                />
              </div>
              {/* End Col */}
        ...
        <div className="container content-space-t-1 content-space-t-md-3">
          ...
          <div className="w-lg-65 text-center mx-lg-auto mb-7">
            ...
            <p className="fs-6">
              Actionable strategies and business marketing advice help you to
              grow faster.
            </p>
          </div>
          {/* End Heading */}
                ...
                <figure className="device-mobile">
                  <div className="device-mobile-frame">
                    <img
                      ...
                      src="assets/img/240x480/img3.jpg"
                      alt="Image Description"
                    />
                  </div>
                </figure>
                ...
                <figure className="device-browser">
                  ...
                  <div className="device-browser-frame">
                    <img
                      ...
                      src="assets/img/800x500/img8.jpg"
                      alt="Image Description"
                    />
                  </div>
                </figure>
              ...
              <div className="devices">
                ...
                <figure className="device-mobile">
                  <div className="device-mobile-frame">
                    <img
                      className="device-mobile-img"
                      src="assets/img/240x480/img4.jpg"
                      alt="Image Description"
                    />
                  </div>
                </figure>
              ...
              <div className="devices">
                ...
                <figure className="device-mobile">
                  <div className="device-mobile-frame">
                    <img
                      className="device-mobile-img"
                      src="assets/img/240x480/img2.jpg"
                      alt="Image Description"
                    />
                  </div>
                </figure>
                ...
                <figure className="device-browser">
                  ...
                  <div className="device-browser-frame">
                    <img
                      className="device-browser-img"
                      src="assets/img/800x500/img1.jpg"
                      alt="Image Description"
                    />
                  </div>
                </figure>
        ...
        <div className="position-relative">
          <div className="container">
            <div className="row justify-content-end align-items-md-center">
              <div
                className="d-none d-md-block col-md-6 position-absolute top-0 start-0 bg-img-center h-100"
                style={{
                  backgroundImage: "url(assets/img/900x700/img7.jpg)",
                }}
              />
              <div className="d-md-none mb-5 mb-md-0">
                <img
                  className="img-fluid"
                  src="assets/img/900x700/img7.jpg"
                  alt="Image Description"
                />
              </div>
              <div className="col-md-6">
                <div className="p-md-5 p-lg-7">
                  ...
                  <div className="mb-4 mb-sm-7">
                    <span className="text-cap">Create a website</span>
                    <h3>Less overhead, more collaboration</h3>
                    <p>
                      Start with award-winning templates, then customize to fit
                      your style and professional needs.
                    </p>
                  </div>
                  {/* End Heading */}
        ...
        <div className="bg-soft-warning">
          <div className="container content-space-1 content-space-md-3">
            ...
            <div className="w-lg-65 text-center mx-lg-auto mb-7">
              ...
              <p className="fs-6">Modernize all the ways you work.</p>
            </div>
            {/* End Heading */}
            <div className="row align-items-md-center mb-5 mb-md-10">
              <div className="col-md-6 mb-5 mb-md-0">
                <div className="text-center">
                  <img
                    className="img-fluid"
                    src="assets/img/illustrations/choice.png"
                    alt="Image Description"
              ...
              <div className="col-md-6">
                ...
                <table className="table">
                  <thead>
                    <tr>
                      <th scope="col" />
                      <th scope="col" className="table-text-end">
                        Others
                      </th>
                      <th scope="col" className="table-text-end">
                        Space
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row">
                        Custom Fields{" "}
                        <i
                          className="bi-info-circle text-muted small ms-1"
                          data-bs-toggle="tooltip"
                          data-bs-placement="top"
                          title="Custom fields allow you to record additional information unique to your contacts, cases or sales opportunities."
                        />
                      </th>
                      <td className="table-text-end">
                        <span className="svg-icon svg-icon-sm text-muted">
                          ...
                          >
                            <rect
                              ...
                              height={2}
                              rx={1}
                              transform="rotate(-45 5.63602 16.9498)"
                              fill="#008060"
                            />
                            <rect
                              opacity="0.3"
                    ...
                    <tr>
                      <th scope="row">
                        ...
                        <i
                          ...
                          data-bs-toggle="tooltip"
                          data-bs-placement="top"
                          title="Shows activities completed by each user and the specific activity types."
                        />
                      </th>
                      <td className="table-text-end">
                        <span className="svg-icon svg-icon-sm text-primary">
                    ...
                    <tr>
                      <th scope="row">
                        ...
                        <i
                          ...
                          data-bs-toggle="tooltip"
                          data-bs-placement="top"
                          title="Add an extra layer of security to your Capsule Account using your mobile device."
                        />
                      </th>
                      <td className="table-text-end">
                        <span className="svg-icon svg-icon-sm text-primary">
                    ...
                    <tr>
                      <th scope="row">
                        ...
                        <i
                          ...
                          data-bs-toggle="tooltip"
                          data-bs-placement="top"
                          title="Use Capsule’s API to integrate with your custom or third party application."
                        />
                      </th>
                      <td className="table-text-end">
                        <span className="svg-icon svg-icon-sm text-muted">
              ...
              <div className="row col-sm-divider">
                <div className="col-sm-4">
                  ...
                  <div className="text-center p-3">
                    <h2 className="text-primary">45k+</h2>
                    <p className="mb-0">
                ...
                <div className="col-sm-4">
                  {/* Info */}
                  <div className="text-center p-3">
                    <h2 className="text-primary">12k+</h2>
                    <p className="mb-0">
        ...
        {/* End Blog */}
        <div className="border-top mx-auto" style={{maxWidth: "30rem"}} />
        {/* FAQ */}
        <div className="container content-space-t-1 content-space-t-md-3">
          {/* Heading */}
          ...
          <div className="w-md-75 w-lg-65 mx-md-auto">
            ...
            <div className="card card-lg">
              ...
              <div className="card-footer bg-soft-warning text-center">
            ...
            <div className="row">
              <div className="col py-3">
                <img
                  ...
                  src="assets/svg/brands/vidados-white.svg"
                  alt="Logo"
                />
              </div>
              {/* End Col */}
              <div className="col py-3">
                <img
                  className="avatar avatar-xl avatar-4x3"
                  src="assets/svg/brands/fitbit-white.svg"
                  alt="Logo"
                />
              </div>
              {/* End Col */}
              <div className="col py-3">
                <img
                  className="avatar avatar-xl avatar-4x3"
                  src="assets/svg/brands/forbes-white.svg"
                  alt="Logo"
                />
              </div>
              {/* End Col */}
              <div className="col py-3">
                <img
                  className="avatar avatar-xl avatar-4x3"
                  src="assets/svg/brands/mailchimp-white.svg"
                  alt="Logo"
                />
              </div>
              {/* End Col */}
              <div className="col py-3">
                <img
                  className="avatar avatar-xl avatar-4x3"
                  src="assets/svg/brands/layar-white.svg"
                  alt="Logo"
                />
              </div>
              {/* End Col */}
                ...
                <form className="js-validate need-validate" noValidate>
                  <div className="mb-3">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      >
                        <i className="bi-chevron-left small me-1" /> Back to Log
                        in
                      </a>
                    </div>
                    {/* End Form */}
      ...
      {/* JS Space */}
      {/* JS Plugins Init. */}
      {/* Mirrored from htmlstream.com/space/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Oct 2021 07:05:47 GMT */}
    </div>
  );
};
